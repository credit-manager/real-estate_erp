...
def paginate(query: Any, serializer: Optional[Callable[..., dict]] = None) -> Tuple[List[dict], int, int, int, int]:
...
def response(items: list, total: int, page: int, per_page: int, pages: int) -> Dict[str, Any]:
...
def paged_or_cap(query: Any, serializer: Optional[Callable[..., dict]] = None) -> Tuple[List[dict], Optional[Dict[str, Any]]]:
