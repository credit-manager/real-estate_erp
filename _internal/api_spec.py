    ...
    spec_kwargs={
        ...
        "info": {
            "description": "2TO - Real Estate Management System API\n\n"
                           ...
                           "## Rate Limiting\n"
                           "Default: 200 requests/minute per IP. Login: 10 requests/minute per IP.\n"
                           "AI queries: 10/minute per IP, 40/day per user.\n\n"
                           "## Error Format\n"
                           "```json\n"
                           "{\n"
                           "  \"success\": false,\n"
...
def register_existing_blueprints(api_instance: Api) -> None:
