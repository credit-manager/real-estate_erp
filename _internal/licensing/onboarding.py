...
def _resolve_admin_password(admin_password: Optional[str] = None) -> Tuple[str, bool]:
...
def create_company(name: str, name_ar: Optional[str] = None, email: Optional[str] = None, phone: Optional[str] = None, tax_number: Optional[str] = None, address: Optional[str] = None, is_trial: bool = True, plan_code: str = "basic", subscription_days: Optional[int] = None, admin_password: Optional[str] = None, admin_full_name: Optional[str] = None) -> Dict[str, Any]:
    try:
...
def create_company_admin(company_id: int, email: str, password: str, full_name: Optional[str] = None) -> Dict[str, Any]:
...
def suspend_company(company_id: int) -> Dict[str, Any]:
    company = db.session.get(LicCompany, company_id)
    if not company:
        return {"success": False, "message": "Company not found"}
...
def reactivate_company(company_id: int) -> Dict[str, Any]:
    company = db.session.get(LicCompany, company_id)
    if not company:
        return {"success": False, "message": "Company not found"}
...
def upgrade_plan(company_id: int, new_plan_code: str) -> Dict[str, Any]:
    company = db.session.get(LicCompany, company_id)
    if not company:
        return {"success": False, "message": "Company not found"}
