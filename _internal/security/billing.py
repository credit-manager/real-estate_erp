...
def create_payment(company_id: int, amount: Union[int, float, Decimal], currency: str = "EGP", payment_method: str = "cash",
                   reference_no: str = "", subscription_id: Optional[int] = None,
...
def confirm_payment(payment_id: int, confirmed_by: Optional[str] = None, actor_email: Optional[str] = None, actor_id: Optional[int] = None, ip: Optional[str] = None) -> Dict[str, Any]:
...
def refund_payment(payment_id: int, reason: str = "", actor_email: Optional[str] = None, actor_id: Optional[int] = None, ip: Optional[str] = None) -> Dict[str, Any]:
...
def fail_payment(payment_id: int, reason: str = "", actor_email: Optional[str] = None, actor_id: Optional[int] = None, ip: Optional[str] = None) -> Dict[str, Any]:
...
def revenue_stats(period: str = "monthly", months: int = 6) -> Dict[str, Any]:
...
def payment_history(company_id: Optional[int] = None, limit: int = 50) -> Dict[str, Any]:
...
def payment_summary_by_company() -> Dict[str, Any]:
