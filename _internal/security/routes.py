...
def _guard() -> Optional[Tuple[Response, int]]:
...
def me() -> Union[Response, Tuple[Response, int]]:
    g = _guard()
    if g:
        return g
    cur = _current()
...
def twofa_status() -> Union[Response, Tuple[Response, int]]:
    g = _guard()
    if g:
        return g
    cur = _current()
...
def twofa_enroll() -> Union[Response, Tuple[Response, int]]:
    g = _guard()
    if g:
        return g
    cur = _current()
...
def twofa_verify() -> Union[Response, Tuple[Response, int]]:
    g = _guard()
    if g:
        return g
    cur = _current()
...
def twofa_disable() -> Union[Response, Tuple[Response, int]]:
    g = _guard()
    if g:
        return g
    cur = _current()
...
def twofa_recovery_codes() -> Union[Response, Tuple[Response, int]]:
    g = _guard()
    if g:
        return g
    cur = _current()
...
def twofa_verify_recovery() -> Union[Response, Tuple[Response, int]]:
    g = _guard()
    if g:
        return g
    cur = _current()
...
def roles() -> Union[Response, Tuple[Response, int]]:
    g = _guard()
    if g:
        return g
...
def permissions() -> Union[Response, Tuple[Response, int]]:
    g = _guard()
    if g:
        return g
...
def sessions() -> Union[Response, Tuple[Response, int]]:
    g = _guard()
    if g:
        return g
    cur = _current()
...
def revoke_session(sid: int) -> Union[Response, Tuple[Response, int]]:
    g = _guard()
    if g:
        return g
    cur = _current()
...
def audit() -> Union[Response, Tuple[Response, int]]:
    g = _guard()
    if g:
        return g
    cur = _current()
...
def analytics_overview() -> Union[Response, Tuple[Response, int]]:
    g = _guard()
    if g:
        return g
    cur = _current()
...
def analytics_company(company_id: int) -> Union[Response, Tuple[Response, int]]:
    g = _guard()
    if g:
        return g
    cur = _current()
...
def analytics_revenue() -> Union[Response, Tuple[Response, int]]:
    g = _guard()
    if g:
        return g
    cur = _current()
...
def analytics_modules() -> Union[Response, Tuple[Response, int]]:
    g = _guard()
    if g:
        return g
    cur = _current()
...
def analytics_subscriptions() -> Union[Response, Tuple[Response, int]]:
    g = _guard()
    if g:
        return g
    cur = _current()
...
def security_events() -> Union[Response, Tuple[Response, int]]:
    g = _guard()
    if g:
        return g
    cur = _current()
...
def security_summary() -> Union[Response, Tuple[Response, int]]:
    g = _guard()
    if g:
        return g
    cur = _current()
...
def login_history() -> Union[Response, Tuple[Response, int]]:
    g = _guard()
    if g:
        return g
    cur = _current()
...
def emergency_kill_all() -> Union[Response, Tuple[Response, int]]:
    g = _guard()
    if g:
        return g
    cur = _current()
...
def kill_sessions(user_id: int) -> Union[Response, Tuple[Response, int]]:
    g = _guard()
    if g:
        return g
    cur = _current()
...
def lock_account(user_id: int) -> Union[Response, Tuple[Response, int]]:
    g = _guard()
    if g:
        return g
    cur = _current()
...
def unlock_account(user_id: int) -> Union[Response, Tuple[Response, int]]:
    g = _guard()
    if g:
        return g
    cur = _current()
...
def token_refresh() -> Union[Response, Tuple[Response, int]]:
    g = _guard()
    if g:
        return g
    data = request.get_json(silent=True) or {}
...
def transition_company(company_id: int) -> Union[Response, Tuple[Response, int]]:
...
def provision_company() -> Union[Response, Tuple[Response, int]]:
...
def _enable_modules(company_id: int, module_codes: List[str], cur: Dict[str, Any]) -> None:
...
def plans_list() -> Union[Response, Tuple[Response, int]]:
    g = _guard()
    if g:
        return g
...
def modules_list() -> Union[Response, Tuple[Response, int]]:
    g = _guard()
    if g:
        return g
...
def plans_create() -> Union[Response, Tuple[Response, int]]:
    g = _guard()
    if g:
        return g
    cur = _current()
...
def plans_update(plan_id: int) -> Union[Response, Tuple[Response, int]]:
    g = _guard()
    if g:
        return g
    cur = _current()
...
def trial_extend(company_id: int) -> Union[Response, Tuple[Response, int]]:
    g = _guard()
    if g:
        return g
    cur = _current()
...
def trial_end(company_id: int) -> Union[Response, Tuple[Response, int]]:
    g = _guard()
    if g:
        return g
    cur = _current()
...
def trial_convert(company_id: int) -> Union[Response, Tuple[Response, int]]:
    g = _guard()
    if g:
        return g
    cur = _current()
...
def sub_renew(company_id: int) -> Union[Response, Tuple[Response, int]]:
    g = _guard()
    if g:
        return g
    cur = _current()
...
def sub_cancel(company_id: int) -> Union[Response, Tuple[Response, int]]:
    g = _guard()
    if g:
        return g
    cur = _current()
...
def lic_suspend(company_id: int) -> Union[Response, Tuple[Response, int]]:
    g = _guard()
    if g:
        return g
    cur = _current()
...
def lic_revoke(company_id: int) -> Union[Response, Tuple[Response, int]]:
    g = _guard()
    if g:
        return g
    cur = _current()
...
def access_check(company_id: int) -> Union[Response, Tuple[Response, int]]:
    g = _guard()
    if g:
        return g
...
def payments_list() -> Union[Response, Tuple[Response, int]]:
    g = _guard()
    if g:
        return g
    cur = _current()
...
def payments_create() -> Union[Response, Tuple[Response, int]]:
    g = _guard()
    if g:
        return g
    cur = _current()
...
def payments_confirm(payment_id: int) -> Union[Response, Tuple[Response, int]]:
    g = _guard()
    if g:
        return g
    cur = _current()
...
def payments_refund(payment_id: int) -> Union[Response, Tuple[Response, int]]:
    g = _guard()
    if g:
        return g
    cur = _current()
...
def payments_fail(payment_id: int) -> Union[Response, Tuple[Response, int]]:
    g = _guard()
    if g:
        return g
    cur = _current()
...
def revenue_stats() -> Union[Response, Tuple[Response, int]]:
    g = _guard()
    if g:
        return g
    cur = _current()
...
def revenue_by_company() -> Union[Response, Tuple[Response, int]]:
    g = _guard()
    if g:
        return g
    cur = _current()
...
@security_bp.route("/modules", methods=["GET"])
def modules_catalog() -> Union[Response, Tuple[Response, int]]:
    g = _guard()
    if g:
        return g
    from security.modules import list_modules
...
def modules_create() -> Union[Response, Tuple[Response, int]]:
    g = _guard()
    if g:
        return g
    cur = _current()
...
def modules_get(module_code: str) -> Union[Response, Tuple[Response, int]]:
    g = _guard()
    if g:
        return g
...
def modules_update(module_code: str) -> Union[Response, Tuple[Response, int]]:
    g = _guard()
    if g:
        return g
    cur = _current()
...
def company_modules(company_id: int) -> Union[Response, Tuple[Response, int]]:
    g = _guard()
    if g:
        return g
...
def company_module_enable(company_id: int, module_code: str) -> Union[Response, Tuple[Response, int]]:
    g = _guard()
    if g:
        return g
    cur = _current()
...
def company_module_disable(company_id: int, module_code: str) -> Union[Response, Tuple[Response, int]]:
    g = _guard()
    if g:
        return g
    cur = _current()
...
def company_module_feature_flag(company_id: int, module_code: str) -> Union[Response, Tuple[Response, int]]:
    g = _guard()
    if g:
        return g
    cur = _current()
...
def company_module_access(company_id: int, module_code: str) -> Union[Response, Tuple[Response, int]]:
    g = _guard()
    if g:
        return g
