...
def transition_company(company: Any, to_status: str, actor_email: Optional[str] = None, actor_id: Optional[int] = None, ip: Optional[str] = None, reason: Optional[str] = None) -> Dict[str, Any]:
