...
def record_event(event_type: str, master_user_id: Optional[int] = None, master_user_email: Optional[str] = None,
                 ip: Optional[str] = None, user_agent: Optional[str] = None, details: Optional[Dict[str, Any]] = None, severity: str = "info") -> None:
...
def get_events(event_type: Optional[str] = None, severity: Optional[str] = None, limit: int = 100) -> Dict[str, Any]:
...
def get_login_history(master_user_id: Optional[int] = None, limit: int = 50) -> Dict[str, Any]:
...
def kill_all_sessions(exclude_user_id: Optional[int] = None) -> Dict[str, Any]:
...
def kill_user_sessions(master_user_id: int, actor_email: Optional[str] = None, actor_id: Optional[int] = None, ip: Optional[str] = None) -> Dict[str, Any]:
...
def lock_account(master_user_id: int, actor_email: Optional[str] = None, actor_id: Optional[int] = None, ip: Optional[str] = None) -> Dict[str, Any]:
...
def unlock_account(master_user_id: int, actor_email: Optional[str] = None, actor_id: Optional[int] = None, ip: Optional[str] = None) -> Dict[str, Any]:
