...
def company_analytics(company_id: int) -> Dict[str, Any]:
...
def revenue_analytics() -> Dict[str, Any]:
...
def module_adoption_stats() -> Dict[str, Any]:
...
def subscription_status_summary() -> Dict[str, Any]:
