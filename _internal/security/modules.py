...
def create_module(code: str, name: str, name_ar: str, description: str = "", version: str = "1.0.0",
                  is_core: bool = False, actor_email: Optional[str] = None, actor_id: Optional[int] = None, ip: Optional[str] = None) -> Dict[str, Any]:
...
def update_module(code: str, updates: Dict[str, Any], actor_email: Optional[str] = None, actor_id: Optional[int] = None, ip: Optional[str] = None) -> Dict[str, Any]:
...
def enable_module_for_company(company_id: int, module_code: str, actor_email: Optional[str] = None, actor_id: Optional[int] = None, ip: Optional[str] = None) -> Dict[str, Any]:
...
def disable_module_for_company(company_id: int, module_code: str, actor_email: Optional[str] = None, actor_id: Optional[int] = None, ip: Optional[str] = None) -> Dict[str, Any]:
    ...
    cm.enabled = False
    cm.disabled_at = datetime.now(timezone.utc)
...
def get_company_modules(company_id: int) -> Dict[str, Any]:
...
def set_feature_flag(company_id: int, module_code: str, flag_name: str, flag_value: Any,
                     actor_email: Optional[str] = None, actor_id: Optional[int] = None, ip: Optional[str] = None) -> Dict[str, Any]:
...
def check_company_module_access(company_id: int, module_code: str) -> Dict[str, Any]:
