...
class RealEstateUnit(db.Model):
    ...
    rent_price = db.Column(db.Numeric(15, 2), default=0)
    price_per_sqm = db.Column(db.Numeric(15, 2), default=0)
    rent_per_sqm = db.Column(db.Numeric(15, 2), default=0)
    sale_method = db.Column(db.String(30), default="cash")

    frontage = db.Column(db.Numeric(8, 2))
    ...
    floor_level = db.Column(db.String(30))
