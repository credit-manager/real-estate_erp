...
class TestModuleCatalog:
    ...
    def test_list_modules(self, master_client):
        resp = master_client.get(f"{SECURITY_BASE}/modules")
        data = resp.get_json()
    ...
    def test_modules_have_required_fields(self, master_client):
        resp = master_client.get(f"{SECURITY_BASE}/modules")
        data = resp.get_json()
    ...
    def test_modules_have_descriptions(self, master_client):
        resp = master_client.get(f"{SECURITY_BASE}/modules")
        data = resp.get_json()
    ...
    def test_modules_all_active(self, master_client):
        resp = master_client.get(f"{SECURITY_BASE}/modules")
        data = resp.get_json()
